...
const Nav = () => {
    ...
    useEffect(() => {
        ...
        .to('.main-nav .items div:nth-child(1) span', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=1')
        .to('.main-nav .items div:nth-child(2) span', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=0.9')
        .to('.main-nav .items div:nth-child(3) span', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=0.9')
        .to('.main-nav .items div:nth-child(4) span', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=0.9')
        .to('.main-nav .items div:nth-child(5) span', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=0.9')
        .to('.main-nav .box .background', {duration: 1, y: 0, ease: Power2.easeInOut}, '-=0.5')
        .to('.main-nav .box .menu div:nth-child(1)', {duration: 1, width: '100%', ease: Power2.easeInOut}, '-=0.75')
